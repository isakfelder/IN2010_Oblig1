...
class SortRunner {
    ...
    static final Sorter[] ALGS1 = { new Quicksort(), new Insertion_sort(), new Mergesort(), new Bogosort()};
    ...
    static final Sorter[] ALGS2 = { new Quicksort(), new Insertion_sort(), new Mergesort(), new Bogosort() };
